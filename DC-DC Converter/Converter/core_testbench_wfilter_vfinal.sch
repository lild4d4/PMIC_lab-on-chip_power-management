...
save v(v_cftop,v_cfbot) v(D1) v(D2) v(D1_N) v(D2_N) v(VOUT_CORE) v(vh) i(v9) i(v3) i(v4) v(v_cftop,v_cfbot) v(D1,v_cftop) v(D2,vout_core) v(D2_N,v_cfbot) v(D1_Nv,VSS) v(v_out_ls1) v(v_out_ls2) v(d2_n,v_cfbot) v(D1_s) v(D2_s)	v(D3_s) v(D4_s)
tran 1n 30u 20u
write signals.raw v(D1) v(D2) v(D1_N) v(D2_N) v(VOUT_CORE) v(vh) i(v9) i(v3) i(v4) v(v_cftop,v_cfbot) v(D1,v_cftop) v(D2,vout_core) v(D2_N,v_cfbot) v(D1_Nv,VSS) v(v_out_ls1) v(v_out_ls2) v(d2_n,v_cfbot) v(D1_s) v(D2_s)	v(D3_s) v(D4_s)
wrdata /foss/designs/IPD413/Simulaciones/core_wfilter.txt v(vout_core) i(v3) i(v4) i(v9) v(v_cftop,v_cfbot)
plot v(VOUT_CORE)
...
C {devices/lab_wire.sym} 200 -400 0 0 {name=l25 sig_type=std_logic lab=D3_s}
C {devices/lab_wire.sym} 200 -350 0 0 {name=l26 sig_type=std_logic lab=D4_s}
...
C {devices/vsource.sym} -910 -570 0 0 {name=V6 value="PULSE(0 1.8 520n 1n 1n 300n 1000n)"}
C {devices/vsource.sym} -910 -660 0 0 {name=V5 value="PULSE(0 1.8 500n 1n 1n 340n 1000n)"}
C {devices/lab_wire.sym} -900 -700 0 1 {name=l43 sig_type=std_logic lab=D2_s}
C {devices/lab_pin.sym} -900 -610 0 1 {name=l2 sig_type=std_logic lab=D3_s
}
C {devices/vsource.sym} -910 -480 0 0 {name=V7 value="PULSE(0 1.8 20n 1n 1n 300n 1000n)"}
C {devices/lab_pin.sym} -900 -520 0 1 {name=l3 sig_type=std_logic lab=D4_s
}
...
C {devices/vsource.sym} -910 -750 0 0 {name=V1 value="PULSE(0 1.8 0n 1n 1n 340n 1000n)"}
...
C {core.sym} 190 -350 0 0 {name=X1}
